...
// import { PluginContainer, PluginData } from './../decorators/plugin.decorator';  // My own decorator
...
//     loadPlugins() {
//         import('/plugins/plugins.js').then((pluginsModule) => {
...
//     loadPlugin(url) {
//         return import(url).then((pluginModule) => {
